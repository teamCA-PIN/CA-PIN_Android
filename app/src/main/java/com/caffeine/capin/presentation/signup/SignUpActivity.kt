package com.caffeine.capin.presentation.signup
...
import com.caffeine.capin.data.dto.login.RequestSignUpData
import com.caffeine.capin.data.dto.login.ResponseSignUpData
...
class SignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val edittextList = listOf<EditText>(username, email, password, newPassword)
                ...
                override fun afterTextChanged(text: Editable?) {
                    if (text.isNullOrEmpty()) {
                        ...
                        edittext.setTextColor(
                            ContextCompat.getColor(this@SignUpActivity, R.color.gray_3)
                        )
                    } else {
                        edittextCount++
                        edittext.setTextColor(
    ...
    private fun checkEditTextEmpty() {
        if (edittextCount >= 4) {
            binding.btnSignup.apply {
                setBackgroundColor(
                    ContextCompat.getColor(this@SignUpActivity, R.color.pointcolor_1)
                )
                background = ContextCompat.getDrawable(this@SignUpActivity, R.drawable.circle_image_view2)
                isClickable = true
            }
        } else {
            binding.btnSignup.apply {
                setBackgroundColor(ContextCompat.getColor(this@SignUpActivity, R.color.gray_3))
                background = ContextCompat.getDrawable(this@SignUpActivity, R.drawable.circle_image_view)
                isClickable = false
            }
        }
    }
